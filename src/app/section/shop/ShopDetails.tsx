...
const products = [
  { id: 1, name: "Headphone", image: "/assets/images/inner/products/1.jpg", price: "$32.00" },
  { id: 2, name: "Luggage", image: "/assets/images/inner/products/2.jpg", price: "$32.00" },
  { id: 3, name: "Watch", image: "/assets/images/inner/products/3.jpg", price: "$32.00" },
  { id: 4, name: "SD Card", image: "/assets/images/inner/products/4.jpg", price: "$32.00" },
];
const images = [
  "/assets/images/inner/products/product-details.jpg",
  "/assets/images/inner/products/product-details2.jpg",
  "/assets/images/inner/products/product-details3.jpg",
];
          ...
          <div className="col-lg-6 col-xl-6">
            <div className="product-gallery">
                ...
                {images.map((img, index) => (
                  <SwiperSlide key={index}>
                    <figure className="image-box">
                      <Link href={img} data-fancybox="gallery">
                        <img
                          src={img}
                          alt="Product Image"
                        />
              ...
              <Swiper
                ...
                slidesPerView={3}
                watchSlidesProgress
                className="product-thumb-slider mt-3">
                {images.map((img, index) => (
                  <SwiperSlide key={index}>
                    <figure>
                      <img
          ...
          <div className="col-lg-6 col-xl-6 product-info">
            ...
            <div className="product-details__content">
              <p className="product-details__content-text1">
                ...
                des mauris commodo ligula commodo leez sed blandit convallis.
              </p>
                ...
                <div className="customer-comment">
                  <div className="row clearfix">
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                      <div className="single-comment-box">
                        <div className="inner-box">
                          <figure className="comment-thumb"><img src="/assets/images/inner/testi-thumb1-2.png" alt="Image" /></figure>
                          <div className="inner">
                            ...
                            <h5>Jon D. William, <span>05 Feb, 2026 . 4:00 pm</span></h5>
                    ...
                    <div className="col-lg-6 col-md-6 col-sm-12 comment-column">
                      <div className="single-comment-box">
                        <div className="inner-box">
                          <figure className="comment-thumb"><img src="/assets/images/inner/testi-thumb1-1.png" alt="Image" /></figure>
                          <div className="inner">
                            <ul className="rating clearfix">
                              <li><i className="fas fa-star" /></li>
                              <li><i className="fas fa-star" /></li>
                            ...
                            <h5>Aleesha Brown, <span>05 Feb, 2026 . 8:00 pm</span></h5>
                            <p>Aliquam hendrerit a augue insuscipit. Etiam aliquam massa quis des mauris commodo.</p>
                          </div>
                        </div>
                      </div>

                  ...
                  <tbody>
                    <tr>
                      <td className="product-thumbnail">
                        <Link href="/shop-product-details"><img alt="product" src="/assets/images/inner/products/1.jpg" /></Link>
                      </td>
                    ...
                    <tr>
                      <td className="product-thumbnail">
                        <Link href="/shop-product-details"><img alt="product" src="/assets/images/inner/products/2.jpg" /></Link>
                      </td>
                    ...
                    <tr>
                      <td className="product-thumbnail">
                        <Link href="/shop-product-details"><img alt="product" src="/assets/images/inner/products/3.jpg" /></Link>
                      </td>
